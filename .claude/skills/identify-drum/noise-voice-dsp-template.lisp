...
(param fc1 @default __FC1__ @min 300 @max 3000 @unit Hz)
(param q1 @default __Q1__ @min 0.5 @max 6)
(param fc2 @default __FC2__ @min 800 @max 6000 @unit Hz)
(param q2 @default __Q2__ @min 0.5 @max 6)
(param g2 @default __G2__ @min 0 @max 4)
(param sp1 @default __SP1__ @min 4 @max 16 @unit ms)
(param sp2 @default __SP2__ @min 4 @max 16 @unit ms)
(param sp3 @default __SP3__ @min 4 @max 16 @unit ms)
(param bdecay @default __BDECAY__ @min -1500 @max -100)
(param l2 @default __L2__ @min 0 @max 3)
(param l3 @default __L3__ @min 0 @max 1.5)
(param l4 @default __L4__ @min 0 @max 1.5)
(param sub_delay @default __SUBDELAY__ @min 1.5 @max 6 @unit ms)
(param sub_gain @default __SUBGAIN__ @min 0 @max 2)
(param burst_amp @default __BURSTAMP__ @min 0.05 @max 20)
(param tail_a1 @default __TA1__ @min 0 @max 10)
(param tail_d1 @default __D1__ @min -150 @max -10)
(param tail_a2 @default __TA2__ @min 0 @max 10)
(param tail_d2 @default __D2__ @min -40 @max -4)
(param tail_lpf @default __TAILLPF__ @min 500 @max 12000 @unit Hz)
(param hp_fc @default __HPFC__ @min 500 @max 10000 @unit Hz)
(param b_hp @default __BHP__ @min 0 @max 1.5)
(param t_hp @default __THP__ @min 0 @max 1.5)
