...
(param onset @default __ONSET__ @min 0 @max 0.004 @unit s)
(param c_end @default __CEND__ @min 100 @max 250 @unit Hz)
(param c_a1 @default __CA1__ @min 500 @max 8000 @unit Hz)
(param c_r1 @default __CR1__ @min -1200 @max -100)
(param c_hold @default __HOLD__ @min 0 @max 0.006 @unit s)
(param c_a2 @default __CA2__ @min 10 @max 1200 @unit Hz)
(param c_r2 @default __CR2__ @min -250 @max -10)
(param m_ratio @default __RATIO__ @min 0.3 @max 0.9)
(param m_a1 @default __MA1__ @min 0.1 @max 600 @unit Hz)
(param m_r1 @default __MR1__ @min -1500 @max -20)
(param attack_time @default __ATTACKTIME__ @min 0.0002 @max 0.03 @unit s)
(param sb_attack @default __SBATTACK__ @min 0.0002 @max 0.03 @unit s)
(param amp_decay @default __AMPDECAY__ @min -40 @max -0.5)
(param amp_curve @default __AMPCURVE__ @min -150 @max 0)
(param body_amp @default __BODYAMP__ @min 0.1 @max 2.5)
(param h0 @default __H0__ @min 0.0001 @max 1.5)
(param h2 @default __H2__ @min 0.0001 @max 1.5)
(param h3 @default __H3__ @min 0.0001 @max 1.5)
(param h4 @default __H4__ @min 0.0001 @max 1.5)
(param h5 @default __H5__ @min 0.0001 @max 1.5)
(param h6 @default __H6__ @min 0.0001 @max 1.5)
(param d0 @default __D0__ @min -80 @max 20)
...
(param p0 @default __P0__ @min 0 @max 1)
(param p2 @default __P2__ @min 0 @max 1)
(param p3 @default __P3__ @min 0 @max 1)
(param p4 @default __P4__ @min 0 @max 1)
(param p5 @default __P5__ @min 0 @max 1)
(param p6 @default __P6__ @min 0 @max 1)
(param click_freq @default __CLICKFREQ__ @min 300 @max 6000 @unit Hz)
(param click_amp @default __CLICKAMP__ @min 0 @max 0.02)
(param click_decay @default __CLICKDECAY__ @min -8000 @max -300)
(param noise_cutoff @default __NOISECUTOFF__ @min 300 @max 12000 @unit Hz)
(param noise_amp @default __NOISEAMP__ @min 0 @max 0.15)
(param noise_decay @default __NOISEDECAY__ @min -2000 @max -100)
