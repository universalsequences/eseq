...
(def mddrw-adsr-panel-for (attack decay sustain release section)
...
(def mddrw-adsr-panel ()
  (if (= monomachine-dpro-ddrw-v1-selected-section 2)
    (mddrw-adsr-panel-for "filter_attack_ms" "filter_decay_ms" "filter_sustain" "filter_release_ms" 2)
    (mddrw-adsr-panel-for "amp_attack_ms" "amp_decay_ms" "amp_sustain" "amp_release_ms" 1)))
