...
(def saw1 (saw_from_phase ph1))
(def saw2 (saw_from_phase ph2))
(def pulse1 (pulse_from_phase ph1 (clip (mod osc1_pw) 0.05 0.95)))
(def pulse2 (pulse_from_phase ph2 (clip (mod osc2_pw) 0.05 0.95)))
(def sub (saw_from_phase phsub))
