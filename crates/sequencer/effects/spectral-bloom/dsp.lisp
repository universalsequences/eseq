...
(param haze   @min 0    @max 1 @default 0.3)  ; phase random-walk: tonal -> airy
(param damp   @min 0    @max 1 @default 0.35) ; highs decay faster
(param freeze @min 0    @max 1 @default 0.0)  ; 1 = stop injecting, sustain forever
...
(def freeze-h  (hop-hold freeze 512))
...
(def jitter-h  (hop-hold (* haze haze 3.5) 512))
