(defeffect-ui
  (h-stack :width :fill :gap 0.35 :align :stretch
    (eseq.effects.custom-ui-lego/ui-lego-column-2
      ...
      (eseq.effects.custom-ui-lego/ui-control-block-medium-s "FEEDBACK" (eseq.effects.custom-ui-lego/ui-accent-orange) 1
        (h-stack :gap 0.32 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-knob-s 1 "shimmer" "shmr" 4.8 (eseq.effects.custom-ui-lego/ui-accent-cyan) 2))))
    (eseq.effects.custom-ui-lego/ui-lego-column-full
      (eseq.effects.custom-ui-lego/ui-control-block-medium-s "OUTPUT" (eseq.effects.custom-ui-lego/ui-accent-green) 2
        (h-stack :gap 0.32 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-knob-s 2 "damping" "damp" 4.8 (eseq.effects.custom-ui-lego/ui-accent-green) 0)
          (eseq.effects.custom-ui-lego/ui-lego-knob-s 2 "width" "width" 4.8 (eseq.effects.custom-ui-lego/ui-accent-violet) 2)
          (eseq.effects.custom-ui-lego/ui-lego-knob-s 2 "mix" "mix" 4.8 (eseq.effects.custom-ui-lego/ui-accent-blue) 2)
