(defmacro op (input) (def value1 0.3) (def phasor2 (phasor value1)) (def phasor1 (phasor input)) (def triangle2 (triangle phasor2)) (def scale1 (scale triangle2 0.0 1.0 1.0 4.0)) (def triangle1 (triangle phasor1 triangle2)) (def mul1 (* triangle1 twopi)) (def cos1 (cos mul1)) (def mul2 (* cos1 scale1)) mul2)
(def gate (in 1 @name gate))
(def pitch (in 2 @name pitch))
(def mul1 (* pitch 1.003))
(def op1 (op pitch))
(def op2 (op mul1))
(def mix1 (mix op1 op2 0.5))
