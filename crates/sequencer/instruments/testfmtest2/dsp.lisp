(defmacro xop (input input2) (def phasor1 (phasor input)) (def triangle1 (triangle phasor1)) (def mul1 (* triangle1 twopi)) (def mul2 (* mul1 input2)) (def cos1 (cos mul2)) cos1)
