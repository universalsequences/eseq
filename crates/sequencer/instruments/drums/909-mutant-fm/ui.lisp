    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-option-s 0 "voice" "drum" 6.0 '("kick" "snare" "lo tom" "mid tom" "hi tom" "rim" "clap" "closed" "open" "ride" "crash") (eseq.effects.custom-ui-lego/ui-accent-cyan)))
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-micro-option-s 0 "body_wave" "wave" 3.6 '("sin" "saw" "pulse" "tri") (eseq.effects.custom-ui-lego/ui-accent-blue))
    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "punch" "punch" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-orange))))
      (h-stack :gap 0.08 :align :start
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "pitch_sweep" "sweep" 3.7 (eseq.effects.custom-ui-lego/ui-accent-blue) 0)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "membrane_fm" "FM" 3.7 (eseq.effects.custom-ui-lego/ui-accent-violet) 2)
...
(def dense-metal-block ()
  (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "MTL" 3.6 (eseq.effects.custom-ui-lego/ui-accent-violet))
        ...
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "hats_decay" "hat" 3.0 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-cyan))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "noise_res" "nQ" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-green))))
      (h-stack :gap 0.08 :align :start
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "body_ratio" "ratio" 3.7 (eseq.effects.custom-ui-lego/ui-accent-blue) 2)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "partial_spread" "spr" 3.7 (eseq.effects.custom-ui-lego/ui-accent-violet) 2)
    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-base-note-s 0 3.1 (eseq.effects.custom-ui-lego/ui-accent-orange))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "gain" "gain" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-orange)))
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "resonance" "res" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-green))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "cross_ring" "ring" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-violet))))
      (h-stack :gap 0.08 :align :start
...
(def lab-readout ()
  (eseq.effects.custom-ui-lego/ui-readout-block-small-s "909 DROPDOWN" (eseq.effects.custom-ui-lego/ui-accent-cyan) 0
    (eseq.effects.custom-ui-lego/ui-lego-text-row-4
      (label "FM everywhere" :font-size 9.0 :color (eseq.effects.custom-ui-lego/ui-accent-violet) :bg :transparent)
      (label "ratio clap" :font-size 9.0 :color (eseq.effects.custom-ui-lego/ui-accent-blue) :bg :transparent)
      (label "metal hats" :font-size 9.0 :color (eseq.effects.custom-ui-lego/ui-accent-orange) :bg :transparent)
      (label "one voice" :font-size 9.0 :color (eseq.effects.custom-ui-lego/ui-accent-cyan) :bg :transparent))))
