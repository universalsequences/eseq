    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.7 :gap 0.18 :align :start
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "MD TOM" 4.6 (eseq.effects.custom-ui-lego/ui-accent-orange))
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rdec" "RDEC" 3.5 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-violet))
    ...
    (if (= e 1)
      (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
        (h-stack :width :fill :height :fill :gap 0.30 :align :center
          (v-stack :width 10.7 :gap 0.18 :align :start
            (h-stack :gap 0.18 :align :start
              (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "TRX-XT" 4.6 (eseq.effects.custom-ui-lego/ui-accent-orange))
              (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rdec" "RDEC" 3.5 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-violet))
              (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "clic" "CLIC" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-cyan)))
            (h-stack :gap 0.18 :align :start
              (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "distype" "DTYP" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-orange))
          ...
          (h-stack :gap 0.10 :align :start
            ...
            (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "distype" "DTYP" 3.9 (eseq.effects.custom-ui-lego/ui-accent-orange) 2))))
      (if (= e 2)
        (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
          (h-stack :width :fill :height :fill :gap 0.30 :align :center
            (v-stack :width 10.7 :gap 0.18 :align :start
              (h-stack :gap 0.18 :align :start
                (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "TRX-XC" 4.6 (eseq.effects.custom-ui-lego/ui-accent-orange))
                (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "clic" "CLIC" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-cyan))
                (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "distype" "DTYP" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-orange)))
              (h-stack :gap 0.18 :align :start
                (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rdec" "RDEC" 3.5 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-violet))
        ...
        (if (= e 3)
          (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
            (h-stack :width :fill :height :fill :gap 0.30 :align :center
              (v-stack :width 10.7 :gap 0.18 :align :start
                (h-stack :gap 0.18 :align :start
                  (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "EFM-XT" 4.6 (eseq.effects.custom-ui-lego/ui-accent-blue))
          ...
          (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
            (h-stack :width :fill :height :fill :gap 0.30 :align :center
              (v-stack :width 10.7 :gap 0.18 :align :start
                (h-stack :gap 0.18 :align :start
                  (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "PI-XT" 4.6 (eseq.effects.custom-ui-lego/ui-accent-green))
                  (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "pos" "POS" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-green))
                  (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "skin_tune" "TUNE" 3.5 2 false (eseq.effects.custom-ui-lego/ui-accent-green)))
                (h-stack :gap 0.18 :align :start
    ...
    (if (= e 3)
      ...
      (if (= e 4)
        (eseq.effects.custom-ui-lego/ui-readout-block-small-s "PI DETAIL" (eseq.effects.custom-ui-lego/ui-accent-green) 0
          (h-stack :gap 0.24 :align :end
            (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "pos" "POS" 3.2 2 false (eseq.effects.custom-ui-lego/ui-accent-green))
            (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "skin_tune" "TUNE" 3.2 2 false (eseq.effects.custom-ui-lego/ui-accent-green))
        ...
        (eseq.effects.custom-ui-lego/ui-readout-block-small-s "TRX DETAIL" (eseq.effects.custom-ui-lego/ui-accent-orange) 0
          (h-stack :gap 0.24 :align :end
            (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "ramp" "RAMP" 3.2 0 false (eseq.effects.custom-ui-lego/ui-accent-violet))
            (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rdec" "RDEC" 3.4 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-violet))
            (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "distype" "DTYP" 3.2 2 false (eseq.effects.custom-ui-lego/ui-accent-orange))))))))
    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.7 :gap 0.18 :align :start
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "eqg" "EQG" 3.5 1 "dB" (eseq.effects.custom-ui-lego/ui-accent-green)))
        (h-stack :gap 0.18 :align :start
    ...
    (eseq.effects.custom-ui-lego/ui-lego-column
      ...
      (eseq.effects.custom-ui-lego/ui-control-panel-dense-s 0
        (h-stack :width :fill :height :fill :gap 0.30 :align :center
          (v-stack :width 10.7 :gap 0.18 :align :start
            (h-stack :gap 0.18 :align :start
              (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "BODY" 4.6 (eseq.effects.custom-ui-lego/ui-accent-green))
