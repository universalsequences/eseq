    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (ui-lego-badge-s 0 "WAVE" 3.6 (ui-accent-cyan))
          (ui-lego-micro-num-s 0 "bits" "bits" 3.1 0 false (ui-accent-orange)))
      ...
      (h-stack :gap 0.08 :align :start
        ...
        (ui-lego-knob-s 0 "wp" "scan" 3.7 (ui-accent-cyan) 0)
        (ui-lego-knob-s 0 "phase_morph" "mrph" 3.7 (ui-accent-violet) 2)))))
...
(def wave3-stack-block ()
  (ui-control-panel-dense-s 0
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (ui-lego-badge-s 0 "STAK" 3.6 (ui-accent-blue))
          (ui-lego-micro-num-s 0 "stack_detune" "det" 3.4 0 "ct" (ui-accent-blue)))
        (h-stack :gap 0.18 :align :start
          (ui-lego-micro-num-s 0 "pan_width" "wid" 3.1 2 false (ui-accent-violet))))
      (h-stack :gap 0.08 :align :start
        (ui-lego-knob-s 0 "stack_semi" "semi" 3.7 (ui-accent-blue) 0)
        (ui-lego-knob-s 0 "stack_level" "lvl" 3.7 (ui-accent-blue) 2)))))
...
(def wave3-sync-block ()
  (ui-control-panel-dense-s 2
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (ui-lego-badge-s 2 "SYNC" 3.6 (ui-accent-violet))
          (ui-lego-micro-option-s 2 "sync_mode" "mode" 4.4 (wave3-sync-options) (ui-accent-violet))))
      (h-stack :gap 0.08 :align :start
        (ui-lego-knob-s 2 "sfrq" "sfrq" 3.7 (ui-accent-violet) 0)
