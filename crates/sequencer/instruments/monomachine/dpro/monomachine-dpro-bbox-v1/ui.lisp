    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "BBOX" 3.8 (eseq.effects.custom-ui-lego/ui-accent-cyan))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "start" "start" 4.4 2 false (eseq.effects.custom-ui-lego/ui-accent-cyan)))
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtrg" "rtrg" 3.3 2 false (eseq.effects.custom-ui-lego/ui-accent-blue))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtim" "rtim" 3.3 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-blue))))
      (h-stack :gap 0.08 :align :start
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "ptch" "pitch" 3.7 (eseq.effects.custom-ui-lego/ui-accent-orange) 0)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "start" "start" 3.7 (eseq.effects.custom-ui-lego/ui-accent-cyan) 2)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 0 "rtrg" "rtrg" 3.7 (eseq.effects.custom-ui-lego/ui-accent-blue) 2)))))
...
(def mbbox-source-strip ()
  (eseq.effects.custom-ui-lego/ui-lego-strip-panel-s 0
    (v-stack :width :fill :gap 0.08 :align :center
      (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "SAMPLE" 5.8 (eseq.effects.custom-ui-lego/ui-accent-cyan))
      (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "ptch" "pitch" 5.8 0 false (eseq.effects.custom-ui-lego/ui-accent-orange))
      (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "start" "start" 5.8 2 false (eseq.effects.custom-ui-lego/ui-accent-cyan))
      (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtrg" "rtrg" 5.8 2 false (eseq.effects.custom-ui-lego/ui-accent-blue))
      (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtim" "rtim" 5.8 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-blue)))))
...
(defsynth-ui
  (h-stack :width :fill :gap 0.30 :align :stretch
    ...
    (eseq.effects.custom-ui-lego/ui-lego-column
      (eseq.effects.custom-ui-lego/ui-control-panel-small-s 0
        (h-stack :gap 0.18 :align :start
          (eseq.effects.custom-ui-lego/ui-lego-badge-s 0 "RTRG" 3.8 (eseq.effects.custom-ui-lego/ui-accent-blue))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtrg" "amt" 3.2 2 false (eseq.effects.custom-ui-lego/ui-accent-blue))
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "rtim" "time" 3.2 0 "ms" (eseq.effects.custom-ui-lego/ui-accent-blue))))
      (eseq.effects.custom-ui-lego/ui-control-panel-small-s 1
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 1 "gain" "gain" 3.2 2 false (eseq.effects.custom-ui-lego/ui-accent-orange))))
      (eseq.effects.custom-ui-lego/ui-readout-panel-small-s 0
        (h-stack :gap 0.34 :align :start
          (label "bbox" :font-size 9.0 :color (eseq.effects.custom-ui-lego/ui-accent-cyan) :bg :transparent)
