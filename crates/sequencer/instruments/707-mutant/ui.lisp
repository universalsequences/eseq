    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          ...
          (ui-lego-micro-option-s 0 "voice" "drum" 5.8 '("kick" "snare" "lo tom" "hi tom" "rim" "clap" "tamb" "closed" "open" "cym") (ui-accent-cyan)))
        (h-stack :gap 0.18 :align :start
          (ui-lego-micro-option-s 0 "body_wave" "wave" 3.6 '("sin" "saw" "pulse" "clip") (ui-accent-blue))
    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (ui-lego-micro-num-s 0 "wobble_rate" "wob" 3.0 0 "Hz" (ui-accent-orange))))
      (h-stack :gap 0.08 :align :start
        (ui-lego-knob-s 0 "pitch_sweep" "sweep" 3.7 (ui-accent-blue) 0)
        (ui-lego-knob-s 0 "pitch_wobble" "warb" 3.7 (ui-accent-violet) 0)
...
(def dense-body-block ()
  (ui-control-panel-dense-s 0
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (ui-lego-badge-s 0 "BODY" 3.6 (ui-accent-violet))
          (ui-lego-micro-num-s 0 "body_ratio" "ratio" 3.0 2 false (ui-accent-blue))
          (ui-lego-micro-num-s 0 "partial_spread" "spr" 2.8 2 false (ui-accent-violet)))
        (h-stack :gap 0.18 :align :start
      ...
      (h-stack :gap 0.08 :align :start
        (ui-lego-knob-s 0 "membrane_fm" "FM" 3.7 (ui-accent-blue) 2)
        (ui-lego-knob-s 0 "cross_ring" "ring" 3.7 (ui-accent-violet) 2)
...
(def dense-damage-block ()
  (ui-control-panel-dense-s 0
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        (h-stack :gap 0.16 :align :start
          (ui-lego-badge-s 0 "MUT" 3.6 (ui-accent-orange))
          (ui-lego-micro-num-s 0 "noise_res" "nQ" 2.8 2 false (ui-accent-cyan))
          (ui-lego-micro-num-s 0 "resonance" "res" 2.8 2 false (ui-accent-green)))
        (h-stack :gap 0.18 :align :start
          (ui-lego-micro-base-note-s 0 3.2 (ui-accent-orange))
...
(def lab-readout ()
  (ui-readout-block-small-s "707 MUTANT LAB" (ui-accent-cyan) 0
    (ui-lego-text-row-4
      (label "note pitched" :font-size 9.0 :color (ui-accent-cyan) :bg :transparent)
      (label "FM / ring" :font-size 9.0 :color (ui-accent-violet) :bg :transparent)
      (label "metal bank" :font-size 9.0 :color (ui-accent-orange) :bg :transparent)
      (label "fold+crush" :font-size 9.0 :color (ui-accent-blue) :bg :transparent))))
