...
(def ph_a        (phasor osc_a_freq))
(def pw          (clip (mod pulse_width) 0.05 0.95))
(def osc_a_sig   (+ (* (mod osc_a_saw)   (polyblep_saw ph_a osc_a_freq))
                    (* (mod osc_a_pulse) (polyblep_pulse ph_a pw osc_a_freq))))
...
(def osc_b_sig    (+ (* (mod osc_b_saw)   (polyblep_saw ph_b osc_b_pitch))
                     (* (mod osc_b_pulse) (polyblep_pulse ph_b pw osc_b_pitch))))
