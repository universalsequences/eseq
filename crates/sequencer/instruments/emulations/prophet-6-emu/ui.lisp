    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 0 "osc_slop" "slop" 3.3 2 false (eseq.effects.custom-ui-lego/ui-accent-orange))))
      (h-stack :gap 0.08 :align :start
    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 1 "filter_env_amt" "env" 3.1 0 false (eseq.effects.custom-ui-lego/ui-accent-blue))))
      (h-stack :gap 0.08 :align :start
...
(def p6e-global-block ()
  (eseq.effects.custom-ui-lego/ui-control-panel-small-s 0
    (h-stack :gap 0.18 :align :start
      ...
      (eseq.effects.custom-ui-lego/ui-lego-micro-num-s 2 "vibrato" "vib" 3.0 2 false (eseq.effects.custom-ui-lego/ui-accent-blue)))))
