    ...
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      (v-stack :width 10.2 :gap 0.18 :align :start
        ...
        (h-stack :gap 0.18 :align :start
          ...
          (ui-lego-micro-num-s 0 "pulse_width" "pw" 3.3 2 false (ui-accent-cyan))))
      (h-stack :gap 0.08 :align :start
...
(def p6i-mix-block ()
  (ui-control-panel-small-s 0
    (h-stack :gap 0.18 :align :start
      ...
      (ui-lego-micro-num-s 0 "osc_slop" "slop" 3.0 2 false (ui-accent-orange))
...
(def p6i-global-block ()
  (ui-control-panel-small-s 0
    (h-stack :gap 0.18 :align :start
      ...
      (ui-lego-micro-num-s 1 "vibrato" "vib" 3.0 2 false (ui-accent-blue)))))
