...
(def freq1 (* pitch osc1_ratio))
(def freq2 (* pitch osc2_ratio))
(def freq3 (* pitch osc3_ratio))
(def ph1 (phasor freq1 (* ph2_wrap (clip (mod sync_amt) 0 1))))
(def ph3 (phasor freq3))

(def tri1 (triangle ph1))
(def saw1 (polyblep_saw ph1 freq1))
(def pulse1 (polyblep_pulse ph1 (clip (mod pulse_width) 0.04 0.96) freq1))
(def tri2 (triangle ph2))
(def saw2 (polyblep_saw ph2 freq2))
(def pulse2 (polyblep_pulse ph2 (clip (mod pulse_width) 0.04 0.96) freq2))
(def tri3 (triangle ph3))
(def saw3 (polyblep_saw ph3 freq3))
(def pulse3 (polyblep_pulse ph3 (clip (mod pulse_width) 0.04 0.96) freq3))
