...
; synth params define the base voice; host Mod slots route into tagged destinations.
...
(def osc_b_saw_sig (polyblep_saw osc_b_phase osc_b_freq))
(def osc_b_tri_sig (triangle osc_b_phase))
(def osc_b_pulse_sig (polyblep_pulse osc_b_phase osc_b_pw_ctl osc_b_freq))
(def osc_b_mix
  (weighted_mix3
...
(def osc_a_pw_ctl
  (clip (+ (mod osc_a_pw)
           ...
           drift_pw)
        0.04 0.96))
(def osc_a_saw_sig (polyblep_saw osc_a_phase osc_a_freq))
(def osc_a_pulse_sig (polyblep_pulse osc_a_phase osc_a_pw_ctl osc_a_freq))
(def osc_a_mix
  (weighted_mix3
