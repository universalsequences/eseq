...
(def o1 (+ (* osc1_saw   (polyblep_saw ph1 f1))
           (* osc1_pulse (polyblep_pulse ph1 pw f1))))
(def o2 (+ (* osc2_saw   (polyblep_saw ph2 f2))
           (* osc2_pulse (polyblep_pulse ph2 pw f2))))
(def o3 (+ (* osc3_saw   (polyblep_saw ph3 f3))
