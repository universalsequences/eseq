  ...
  (drift-panel-small 0 (drift-surf-warm) (drift-bord-warm) (drift-pink)
    (drift-small-row
      (h-stack :gap 0.82 :align :end
        ...
        (eseq.effects.custom-ui-lego/ui-lego-micro-option-s 0 "osc1_on" "osc1" 3.4 (drift-onoff-options) (drift-orange))
        (eseq.effects.custom-ui-lego/ui-lego-micro-option-s 0 "osc2_on" "osc2" 3.4 (drift-onoff-options) (drift-ice))))))
...
(def drift-filter-block ()
  (drift-panel-dense 1 (drift-surf-cool) (drift-bord-cool) (drift-ice)
    (h-stack :width :fill :height :fill :gap 0.30 :align :center
      ...
      (h-stack :gap 0.10 :align :start
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 1 "lp_freq" "cut" 3.7 (drift-ice) 0)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 1 "lp_res" "res" 3.7 (drift-ice) 2)
        (eseq.effects.custom-ui-lego/ui-lego-knob-s 1 "hp_freq" "hp" 3.7 (drift-cream) 0)))))
