...
(def scale1 (scale triangle2 0.0 1.0 50.0 5000.0))
...
(def triangle1 (triangle phase triangle2))
(def mul1 (* triangle1 twopi))
(def cos1 (cos mul1))
(def svf1 (svf cos1 scale1 0.9 0.0))
(out (* svf1 env velocity (mod gain)) 1 @name audio)