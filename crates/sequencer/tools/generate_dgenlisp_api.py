...
CURATED_OPERATORS = {
    ...
    "event-hold": {"category": "stateful", "summary": "Sample on positive trigger frames and schedule pure consumers on that event clock. Latch final coefficients back to audio rate. C forward rendering only.", "signatures": ["(event-hold value trigger)"], "arity": {"minimum": 2, "maximum": 2}},
