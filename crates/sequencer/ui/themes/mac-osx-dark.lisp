...
(def mac-osx-theme () 
  (apply-theme (dict
      ...
      :patcher-autocomplete-bg '(0.09 0.09 0.11)
      :patcher-autocomplete-border '(0.18 0.19 0.21)
      ...
      :patcher-autocomplete-doc-bg '(0.08 0.09 0.10)
      :patcher-autocomplete-doc-border '(0.17 0.18 0.20)
