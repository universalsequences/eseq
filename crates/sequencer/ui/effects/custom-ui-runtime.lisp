...
;; per-instrument ui.lisp files (crates/sequencer/instruments/**/ui.lisp),
...
(module-compat-alias inst-param inst-param)
(module-compat-alias inst-base-note-param inst-base-note-param)
(module-compat-alias ui-param-control ui-param-control)
(module-compat-alias custom-ui-scope-name custom-ui-scope-name)
(module-compat-alias custom-ui-current-scope custom-ui-current-scope)
(module-compat-alias custom-ui-param-in-scope custom-ui-param-in-scope)
(module-compat-alias custom-ui-set-param-in-scope custom-ui-set-param-in-scope)
(module-compat-alias custom-ui-set-param-by-name-in-scope custom-ui-set-param-by-name-in-scope)
(module-compat-alias custom-ui-set-adsr-in-scope custom-ui-set-adsr-in-scope)
(module-compat-alias custom-ui-param-change-callback custom-ui-param-change-callback)
(module-compat-alias custom-ui-param-change-callback-s custom-ui-param-change-callback-s)
(module-compat-alias custom-ui-current-param custom-ui-current-param)
(module-compat-alias custom-ui-current-tensor-param custom-ui-current-tensor-param)
(module-compat-alias custom-ui-current-base-note-param custom-ui-current-base-note-param)
(module-compat-alias custom-ui-set-param custom-ui-set-param)
(module-compat-alias custom-ui-param-binding custom-ui-param-binding)
(module-compat-alias custom-ui-param-value custom-ui-param-value)
(module-compat-alias custom-ui-param-control-min custom-ui-param-control-min)
(module-compat-alias custom-ui-param-control-max custom-ui-param-control-max)
(module-compat-alias custom-ui-param-mod-wrapper custom-ui-param-mod-wrapper)
(module-compat-alias custom-ui-param-control-key-mode custom-ui-param-control-key-mode)
(module-compat-alias custom-ui-param-base-value-prop custom-ui-param-base-value-prop)
(module-compat-alias custom-ui-param-base-min-prop custom-ui-param-base-min-prop)
(module-compat-alias custom-ui-param-base-max-prop custom-ui-param-base-max-prop)
(module-compat-alias custom-ui-param-plock-active? custom-ui-param-plock-active?)
(module-compat-alias custom-ui-param-plock-default custom-ui-param-plock-default)
(module-compat-alias custom-ui-param-plock-text-color custom-ui-param-plock-text-color)
(module-compat-alias custom-ui-param-knob-mod-slot-prop custom-ui-param-knob-mod-slot-prop)
(module-compat-alias custom-ui-param-knob-mod-depth-prop custom-ui-param-knob-mod-depth-prop)
(module-compat-alias custom-ui-selected-mod-slot-prop custom-ui-selected-mod-slot-prop)
(module-compat-alias custom-ui-tensor-bound-values custom-ui-tensor-bound-values)
(module-compat-alias custom-ui-tensor-cell-change-callback custom-ui-tensor-cell-change-callback)
(module-compat-alias custom-ui-tensor-cell-change-callback-s custom-ui-tensor-cell-change-callback-s)
(module-compat-alias base-note base-note)
