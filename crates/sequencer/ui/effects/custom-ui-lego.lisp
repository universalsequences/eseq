...
(import eseq.effects.custom-ui-runtime :refer
  (eseq.effects.custom-ui-runtime/custom-ui-current-param eseq.effects.custom-ui-runtime/custom-ui-current-tensor-param
   eseq.effects.custom-ui-runtime/custom-ui-current-base-note-param eseq.effects.custom-ui-runtime/custom-ui-current-scope
   eseq.effects.custom-ui-runtime/custom-ui-scope-name eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper
   eseq.effects.custom-ui-runtime/custom-ui-param-control-key-mode eseq.effects.custom-ui-runtime/custom-ui-param-binding
   eseq.effects.custom-ui-runtime/custom-ui-param-value eseq.effects.custom-ui-runtime/custom-ui-param-control-min
   eseq.effects.custom-ui-runtime/custom-ui-param-control-max eseq.effects.custom-ui-runtime/custom-ui-param-base-value-prop
   eseq.effects.custom-ui-runtime/custom-ui-param-base-min-prop eseq.effects.custom-ui-runtime/custom-ui-param-base-max-prop
   eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop
   eseq.effects.custom-ui-runtime/custom-ui-selected-mod-slot-prop eseq.effects.custom-ui-runtime/custom-ui-param-plock-text-color
   eseq.effects.custom-ui-runtime/custom-ui-param-plock-active? eseq.effects.custom-ui-runtime/custom-ui-param-plock-default
   eseq.effects.custom-ui-runtime/custom-ui-param-change-callback eseq.effects.custom-ui-runtime/custom-ui-param-change-callback-s
   eseq.effects.custom-ui-runtime/custom-ui-tensor-bound-values eseq.effects.custom-ui-runtime/custom-ui-tensor-cell-change-callback-s
   eseq.effects.custom-ui-runtime/custom-ui-set-param-in-scope eseq.effects.custom-ui-runtime/custom-ui-set-adsr-in-scope))
(import eseq.effects.custom-ui-sections :refer
  (eseq.effects.custom-ui-sections/custom-ui-select-section-in-scope eseq.effects.custom-ui-sections/custom-ui-set-active-adsr
   eseq.effects.custom-ui-sections/custom-ui-adsr-stage-active? eseq.effects.custom-ui-sections/ui-section-select-callback eseq.effects.custom-ui-sections/ui-panel-bg))
(import eseq.effects.custom-ui-controls :refer (eseq.effects.custom-ui-controls/ui-param-bound-value))
(import eseq.effects.param-controls :refer
  (eseq.effects.param-controls/custom-ui-option-index eseq.effects.param-controls/param-plock-color-r eseq.effects.param-controls/param-plock-color-g
      ...
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-lego-knob-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-lego-knob-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) (eseq.effects.custom-ui-runtime/custom-ui-param-control-key-mode p) "-" name)
          (knob-number :label title
            ...
            :mod-range-2-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 2) :mod-range-2-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 2)
            :mod-range-3-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 3) :mod-range-3-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 3)
            :mod-range-4-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 4) :mod-range-4-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 4)
            :mod-range-5-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 5) :mod-range-5-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 5)
            :mod-range-6-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 6) :mod-range-6-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 6)
            :mod-range-7-slot (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-slot-prop p 7) :mod-range-7-depth (eseq.effects.custom-ui-runtime/custom-ui-param-knob-mod-depth-prop p 7)
...
(def ui-lego-num (name title width decimals unit accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-param name)))
    (if p
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-lego-num-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-lego-num-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) (eseq.effects.custom-ui-runtime/custom-ui-param-control-key-mode p) "-" name)
...
(def ui-lego-matrix-s (section name title width height accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-tensor-param name)))
    (if p
      (subtree :key (str "custom-ui-lego-matrix-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (v-stack :width width :height height :gap 0.10 :align :start
          ...
          (matrix :rows (get p :rows) :cols (get p :cols)
            :value (eseq.effects.custom-ui-runtime/custom-ui-tensor-bound-values p)
        ...
        (subtree :key (str "custom-ui-lego-option-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
          (v-stack :width width :height 1.12 :gap 0.08 :align :start
            ...
            (dropdown :value-index (eseq.effects.custom-ui-runtime/custom-ui-param-binding p)
              ...
              :on-change (lambda (v)
                (eseq.effects.custom-ui-runtime/custom-ui-set-param-in-scope
                  scope
                  p
...
(def ui-lego-micro-option-s (section name title width options accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-param name))
        (scope (eseq.effects.custom-ui-runtime/custom-ui-current-scope)))
    (if p
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-lego-micro-option-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-lego-micro-option-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
          (box :width width :height 1.18 :v-align :end
            (dropdown :value-index (eseq.effects.custom-ui-runtime/custom-ui-param-binding p)
              :value-index-offset (get p :min)
              :options options
...
(def ui-lego-row (name title decimals unit accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-param name)))
    (if p
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-lego-row-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-lego-row-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
...
(def ui-lego-base-note (width accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-base-note-param)))
    (if p
      (subtree :key (str "custom-ui-lego-base-note-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name))
        (v-stack :width width :height 1.12 :gap 0.08 :align :start
...
(def %ui-adsr-number (stage name title decimals unit)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-param name)))
    (if p
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-adsr-number-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-adsr-number-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
  ...
  (box :width (ui-lego-col-w) :height (ui-lego-full-h)
    ...
    (v-stack :width :fill :height :fill :gap 0.10
      ...
      (adsr-editor
        ...
        :release (if release (eseq.effects.custom-ui-controls/ui-param-bound-value release 120) 0)
        :width :fill :flex 1
        :background-color :instrument-control-bg
  ...
  (box :width 23.1 :height :fill
    ...
    (v-stack :width :fill :height :fill :gap 0.10
      ...
      (adsr-editor
        ...
        :on-change (lambda (env)
          (do
            (eseq.effects.custom-ui-sections/custom-ui-set-active-adsr scope -1 (get env :active))
            (eseq.effects.custom-ui-runtime/custom-ui-set-adsr-in-scope scope attack decay sustain release env))))
      (box :width :fill :height 1.75 :padding 0.15
        (h-stack :width :fill :gap 0.20 :align :start
...
(def %ui-detail-adsr-wide-tab-s (section title width selected)
  (ui-lego-underline-tab
    ...
    (eseq.effects.custom-ui-sections/ui-section-select-callback section)
    (str "adsr-tab-" title)))
...
(def ui-lego-vfader-s (section name width height accent)
  (let ((p (eseq.effects.custom-ui-runtime/custom-ui-current-param name)))
    (if p
      (eseq.effects.custom-ui-runtime/custom-ui-param-mod-wrapper p (str "custom-ui-lego-vfader-mod-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) "-" name)
        (subtree :key (str "custom-ui-lego-vfader-" (eseq.effects.custom-ui-runtime/custom-ui-scope-name) (eseq.effects.custom-ui-runtime/custom-ui-param-control-key-mode p) "-" name)
          (vslider :width 0.1 :height height
            :min (eseq.effects.custom-ui-runtime/custom-ui-param-control-min p) :max (eseq.effects.custom-ui-runtime/custom-ui-param-control-max p)
            :origin (eseq.effects.custom-ui-runtime/custom-ui-param-control-min p)
            :value (eseq.effects.custom-ui-runtime/custom-ui-param-binding p)
            :color :white
            :fill accent
