...
(module-compat-alias instrument-panel-tab instrument-panel-tab)
(module-compat-alias instrument-source-tab instrument-source-tab)
(module-compat-alias instrument-mods-open instrument-mods-open)
(module-compat-alias instrument-selected-mod-slot instrument-selected-mod-slot)
(module-compat-alias instrument-key-lock-octave instrument-key-lock-octave)
(module-compat-alias instrument-key-lock-selected-notes instrument-key-lock-selected-notes)
(module-compat-alias instrument-key-lock-audition instrument-key-lock-audition)
(module-compat-alias rack-panel-slot-list-open rack-panel-slot-list-open)
(module-compat-alias rack-panel-selected-chain-open rack-panel-selected-chain-open)
(module-compat-alias rack-panel-macros-open rack-panel-macros-open)
(module-compat-alias effect-mods-open effect-mods-open)
(module-compat-alias effect-mods-chain effect-mods-chain)
(module-compat-alias effect-mods-track effect-mods-track)
(module-compat-alias effect-mods-slot effect-mods-slot)
(module-compat-alias effect-mods-rack-slot effect-mods-rack-slot)
(module-compat-alias effect-mods-bus effect-mods-bus)
(module-compat-alias effect-selected-mod-slot effect-selected-mod-slot)
(module-compat-alias process-panel-selected-track process-panel-selected-track)
(module-compat-alias process-panel-selected-instance-id process-panel-selected-instance-id)
(module-compat-alias seq-timebase-options seq-timebase-options)
(module-compat-alias fx-fixed-panel-height fx-fixed-panel-height)
(module-compat-alias fx-panel-header-height fx-panel-header-height)
(module-compat-alias fx-panel-body-content-height fx-panel-body-content-height)
