...
(module-compat-alias seqv-track-drum-rack? seqv-track-drum-rack?)
(module-compat-alias seqv-track-drum-sounds seqv-track-drum-sounds)
(module-compat-alias seqv-drum-sound-mode? seqv-drum-sound-mode?)
(module-compat-alias seqv-drum-sound-count seqv-drum-sound-count)
(module-compat-alias seqv-drum-sound-labels seqv-drum-sound-labels)
(module-compat-alias seqv-drum-sound-short-labels seqv-drum-sound-short-labels)
(module-compat-alias seqv-drum-sound-index-for-transpose seqv-drum-sound-index-for-transpose)
(module-compat-alias seqv-drum-sound-label-for-transpose seqv-drum-sound-label-for-transpose)
(module-compat-alias seqv-drum-sound-transpose-at-index seqv-drum-sound-transpose-at-index)
(module-compat-alias seqv-drum-sound-transpose-for-label seqv-drum-sound-transpose-for-label)
(module-compat-alias seqv-process-lane-mode-offset seqv-process-lane-mode-offset)
(module-compat-alias seqv-process-lane-mode? seqv-process-lane-mode?)
(module-compat-alias seqv-process-lane-index seqv-process-lane-index)
(module-compat-alias seqv-track-process-lanes seqv-track-process-lanes)
(module-compat-alias seqv-track-process-lane seqv-track-process-lane)
(module-compat-alias seqv-current-param-values seqv-current-param-values)
(module-compat-alias seqv-track-param-values seqv-track-param-values)
(module-compat-alias seqv-param-value-at seqv-param-value-at)
(module-compat-alias seqv-param-min seqv-param-min)
(module-compat-alias seqv-param-max seqv-param-max)
(module-compat-alias seqv-param-haptic-pivot-position seqv-param-haptic-pivot-position)
(module-compat-alias seqv-param-haptic-exponent seqv-param-haptic-exponent)
(module-compat-alias seqv-param-keyword seqv-param-keyword)
(module-compat-alias seqv-param-color seqv-param-color)
(module-compat-alias seqv-param-name seqv-param-name)
(module-compat-alias seqv-range-origin seqv-range-origin)
(module-compat-alias seqv-param-origin seqv-param-origin)
(module-compat-alias seqv-param-decimals seqv-param-decimals)
(module-compat-alias seqv-track-param-min seqv-track-param-min)
(module-compat-alias seqv-track-param-max seqv-track-param-max)
(module-compat-alias seqv-track-param-name seqv-track-param-name)
(module-compat-alias seqv-track-param-origin seqv-track-param-origin)
(module-compat-alias seqv-track-param-decimals seqv-track-param-decimals)
(module-compat-alias seqv-track-param-slider-min seqv-track-param-slider-min)
(module-compat-alias seqv-track-param-slider-max seqv-track-param-slider-max)
(module-compat-alias seqv-track-param-haptic-pivot-value seqv-track-param-haptic-pivot-value)
(module-compat-alias seqv-step-param-value seqv-step-param-value)
(module-compat-alias seqv-step-slider-param-value seqv-step-slider-param-value)
(module-compat-alias seqv-track-step-param-value seqv-track-step-param-value)
(module-compat-alias seqv-track-step-slider-param-value seqv-track-step-slider-param-value)
