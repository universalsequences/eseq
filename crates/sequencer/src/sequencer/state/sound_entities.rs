    ...
    pub fn new_default() -> Self {
        ...
        Self {
            params: PatchParams {
                ...
                mono_trigger: params.mono_trigger,
                voice_priority: params.voice_priority,
    ...
    pub fn split(self) -> (TrackPatternSeq, Patch, Mix) {
        ...
        let patch = Patch {
            params: PatchParams {
                ...
                mono_trigger: track_params.mono_trigger,
                voice_priority: track_params.voice_priority,
    ...
    pub fn compose(seq: &TrackPatternSeq, patch: &Patch, mix: &Mix) -> TrackPatternData {
        ...
        TrackPatternData {
            ...
            track_params: TrackParamsSnapshot {
                ...
                mono_trigger: patch.params.mono_trigger,
                voice_priority: patch.params.voice_priority,
