...
use super::{
    ...
    get_f32_prop, mapped_haptic_value, gpu_widget_instance, ndc_bounds, plock_active,
...
const HSLIDER_FRAGMENT_SHADER: super::ShaderSources = super::ShaderSources::both(r#"
...
"#, super::wgsl::HSLIDER_FRAGMENT_SHADER);
...
impl WidgetDefinition for HorizontalSliderWidget {
    ...
    fn fragment_shader(
        ...
        HSLIDER_FRAGMENT_SHADER.source(backend)
    }
