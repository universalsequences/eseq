...
use super::display::{
    node_autogenerated_size_for_ports, node_display_label, node_font_size, node_size_for_ports,
};
...
pub(super) fn connect_last_touched_nodes(
    ...
    let to_input = input_indices
        ...
        .unwrap_or(0);
    let already_connected = patch.connections.iter().any(|connection| {
        connection.from_node == source
            && connection.from_output == 0
            && connection.to_node == dest
