...
/// underestimated every label by the retina scale factor.) Measured against
/// CoreText, the real value ranges 0.055-0.065 for the system font over the
/// mono cell across node/code font sizes and scale factors; this sits at the
/// top of that range so the estimate never packs nodes tighter than they
/// render.
