(defsynth-ui
  (eseq.effects.physical-model-surface/panel "PM BONANG"
    (list
    ...
    (list
      ...
      (dict :title "Tuning"
        :view (lambda () (eseq.effects.physical-model-surface/gamelan-tuning-view 72.7967))
        :controls (lambda () '(("tuning.amount" "Recorded tuning" 2) ("tuning.tune" "Tune cents" 1)))
        :hint "Measured MIDI keys: 60, 63, 65, 68, 70, 72, 74, 75, 77, 80, 82, 84, 87.")
      (dict :title "Damping"
        :view (lambda () (eseq.effects.physical-model-surface/gamelan-damper-view 1.59529))
