(defsynth-ui
  (eseq.effects.physical-model-surface/panel "PM SLENTHEM"
    (list
    ...
    (list
      (dict :title "Mallet"
        :view (lambda () (eseq.effects.physical-model-surface/gamelan-mallet-view 3.6))
      ...
      (dict :title "Tuning"
        :view (lambda () (eseq.effects.physical-model-surface/gamelan-tuning-view -36.971))
        :controls (lambda () '(("tuning.amount" "Recorded tuning" 2) ("tuning.tune" "Tune cents" 1)))
        :hint "Measured MIDI keys: 50, 52, 53, 56, 57, 58, 60.")
      (dict :title "Damping"
        :view (lambda () (eseq.effects.physical-model-surface/gamelan-damper-view 1.14178))
