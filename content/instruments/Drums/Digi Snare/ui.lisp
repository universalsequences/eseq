...
(defsynth-ui
  (eseq.effects.drum-surface/panel "DIGI SNARE"
    ...
    (list
      (dict :title "Play" :controls (lambda () (list (list "engine" "Engine" 0 '("TRX-SD" "EFM-SD" "EFM-RS")) (list "ptch" "Pitch" 1 nil) (list "dec" "Decay ms" 0 nil) (list "humanize" "Humanize" 2 nil) (list "level" "Level" 2 nil)))
