...
(def vox-source ()
  (v-stack :gap 0.3
    ...
    (eseq.effects.mnm-surface/mnm-caption "Drag to change the glottal opening.")))
...
(def vox-vowel ()
  (let ((scope (eseq.effects.custom-ui-runtime/custom-ui-current-scope))
    ...
    (v-stack :gap 0.25
      ...
      (eseq.effects.mnm-surface/mnm-caption "Drag X: shift, Y: focus. Morph blends into the next vowel."))))
(def vox-consonant ()
  (let ((scope (eseq.effects.custom-ui-runtime/custom-ui-current-scope))
