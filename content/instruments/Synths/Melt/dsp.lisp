...
; Factory Melt: the original local FM engine and envelope behavior.
...
(param op1_release_ms @default 300 @min 5 @max 8000 @unit ms)

(param op2_release_ms @default 140 @min 5 @max 8000 @unit ms)
...
(def env1 (adsr gate trigger op1_attack_ms op1_decay_ms op1_sustain op1_release_ms))
(def env2 (adsr gate trigger op2_attack_ms op2_decay_ms op2_sustain op2_release_ms))
