...
;; Aura moved to the sequencer theme registry (ui/themes/aura.lisp), which
;; carries the full slot set and the track-color palette snap. Keep the old
;; editor entry point as a thin alias so nothing here drifts from it again.
(def aura-theme ()
